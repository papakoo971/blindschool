...
const posts = [
  {
    ...
    meta: "익명 · 고등학교 · 대구 · 도움됨 38 · 댓글 12",
  },
  {
    category: "고충",
    title: "생활지도 관련 민원 대응 매뉴얼이 학교마다 너무 다릅니다",
    meta: "익명 · 중학교 · 경북 · 도움됨 24 · 댓글 9",
  },
  {
    category: "학교문화",
    title: "회의록 공유 방식이 통일되면 신규 교직원 적응이 빠를 것 같습니다",
    meta: "익명 · 초등학교 · 부산 · 도움됨 19 · 댓글 5",
  },
];
    ...
    <main className="app-shell">
      <aside className="sidebar" aria-label="관리자 메뉴">
        <div>
          ...
          <p className="brand-copy">플랫폼 관리자 대시보드</p>
        </div>
        <nav className="nav-list">
          <a href="/home">교직원 홈</a>
          <a href="/community">커뮤니티</a>
          <a href="/workhub">업무허브</a>
          <a href="/verification">인증상태</a>
          <a href="/">공개 홈</a>
        </nav>
      ...
      <section className="workspace">
        <header className="topbar">
          <div>
            ...
            <h1>인증, 신고, 업무 흐름을 운영 관점에서 확인합니다.</h1>
          </div>
        ...
        <section className="stat-grid" aria-label="서비스 현황">
          {stats.map((stat) => (
        ...
        <section className="dashboard-grid">
          <article className="panel verification-panel">
            ...
            <div className="score-block">
              ...
              <div className="score-copy">
                ...
                <p>자동 승인, 수동 검토, 반려를 분기하고 모든 관리자 조치는 감사 로그에 남깁니다.</p>
              </div>
            </div>
          ...
          <article className="panel">
            <div className="panel-heading">
              <div>
                <p className="eyebrow">커뮤니티 모니터링</p>
                <h2>오늘 올라온 주요 의견</h2>
              </div>
              <span className="status-pill quiet">지역 표시</span>
            </div>
